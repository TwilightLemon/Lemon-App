...
{
    public static async Task<string> GetCoverImgUrl(HttpClient hc,Music m)
    {
        if (m.Album != null && m.Album.Id != null)
            return $"https://y.gtimg.cn/music/photo_new/T002R500x500M000{m.Album.Id}.jpg?max_age=2592000";
        else
        {
            string json = await hc.SetCookie("").GetStringAsync("https://y.qq.com/n/ryqq/songDetail/" + m.MusicID);
